...
var RecommendationsController = function () {
    var _classDecorators = [(0, common_1.Controller)('recommendations')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _getRecommendations_decorators;
    var RecommendationsController = _classThis = /** @class */ (function () {
        function RecommendationsController_1(recommendationsService) {
            this.recommendationsService = (__runInitializers(this, _instanceExtraInitializers), recommendationsService);
        }
        RecommendationsController_1.prototype.getRecommendations = function (item) {
            return __awaiter(this, void 0, void 0, function () {
                var trimmedItem, recommendations;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!item || item.trim().length === 0) {
                                throw new common_1.BadRequestException('Query parameter "item" is required');
                            }
                            trimmedItem = item.trim();
                            return [4 /*yield*/, this.recommendationsService.getRecommendations(trimmedItem)];
                        case 1:
        ...
        return RecommendationsController_1;
    }());
    __setFunctionName(_classThis, "RecommendationsController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _getRecommendations_decorators = [(0, common_1.Get)()];
